...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False, help_text="Whether this payout includes scout bonus"
            ),
        ),
        migrations.AddField(
            model_name="payout",
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                blank=True, help_text="When this payout was verified", null=True
            ),
        ),
        migrations.AddIndex(
            model_name="fleetparticipant",
            index=models.Index(
                fields=["is_scout"], name="aapayout_fl_is_scou_3df9c4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="fleetparticipant",
            index=models.Index(
                fields=["excluded_from_payout"], name="aapayout_fl_exclude_cc8cf3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="fleetparticipant",
            index=models.Index(
                fields=["main_character"], name="aapayout_fl_main_ch_6fb747_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payout",
            index=models.Index(
                fields=["is_scout_payout"], name="aapayout_pa_is_scou_4d0178_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payout",
            index=models.Index(
                fields=["verified"], name="aapayout_pa_verifie_df8471_idx"
            ),
        ),
    ]
