        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, help_text="When the import was performed"
                    ),
                ),
                (
                    "characters_found",
                    models.IntegerField(
                        default=0, help_text="Total characters in ESI fleet"
                    ),
                ),
                (
                    "characters_added",
                ...
                (
                    "characters_skipped",
                    models.IntegerField(
                        default=0, help_text="Already in fleet, skipped"
                    ),
                ),
                (
                    "unique_players",
                    models.IntegerField(
                        default=0, help_text="Unique players after deduplication"
                    ),
                ),
                (
                    "raw_data",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["esi_fleet_id"], name="aapayout_es_esi_fle_36af59_idx"
                    ),
                ],
            },
        ),
