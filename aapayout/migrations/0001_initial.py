...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Fleet name or operation name", max_length=200
                    ),
                ),
                (
                    "doctrine",
                ...
                (
                    "location",
                    models.CharField(
                        help_text="Primary operation location", max_length=200
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="Fleet Loot", help_text="Loot pool name", max_length=200
                    ),
                ),
                (
                    "raw_loot_text",
                    models.TextField(
                        blank=True, help_text="Raw loot paste from EVE client"
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Time when loot was valued", null=True
                    ),
                ),
                (
                    "approved_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "paid_at",
                    models.DateTimeField(
                        blank=True, help_text="Time when marked as paid", null=True
                    ),
                ),
                ("notes", models.TextField(blank=True, help_text="Additional notes")),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "joined_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text="Time joined fleet"
                    ),
                ),
                (
                    "left_at",
        ...
        migrations.AddIndex(
            model_name="fleet",
            index=models.Index(
                fields=["-fleet_time"], name="aapayout_fl_fleet_t_d9d5a4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="fleet",
